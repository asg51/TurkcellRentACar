...
public class CarCrashInformationController 
{
    ...
    public DataResult<CarCrashInformationDto> getByCarCrashInformationId(@RequestParam("carCrashInformationId") int carCrashInformationId) throws BusinessException 
    {
