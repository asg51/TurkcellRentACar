...
public class CarsController 
{
    ...
    public Result updateKilometerInformation(@RequestBody UpdateCarKilometerInformationRequest updateCarKilometerInformationRequest) throws BusinessException
    {
        return this.carService.updateCarKilometerInformation(updateCarKilometerInformationRequest);
    }
